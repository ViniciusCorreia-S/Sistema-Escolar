...
////MELHORIAS FUTURAS:
//// - Adicionar permanencia de dados para turmas
//// - Permitir digitar letra e numero para nome de turma
...
//    //static List<Aluno> CarregarTurmas()
//    //{
...
//    //    return JsonSerializer.Deserialize<List<Turma>>(json)
//    //           ?? new List<Turma>();
//    //}
...
//        //if (alunoSelecionado.StartsWith("0")) return;
...
//        );
//        //if (profSelecionado.StartsWith("0")) return;
